    ...
    return (
        <div className="main__head">
            ...
            <svg className="main__head-wave top" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 510" fill="none">
                <path d="M796 5.3272C480 -33.8728 -86.1667 152.5 -178 262L-230 509.827H2266.5C2338.17 394.494 2167.7 62.2006 1936.5 81.0006C1647.5 104.501 1727 492.327 1418 437.327C1109 382.327 1191 54.3272 796 5.3272Z" fill="#8E2C05" fillOpacity="0.1"/>
            </svg>
            ...
            <div className="main__head-inner">
                <div className="main__head-content">
                    <div className="main__head-block left">
                        <h2>SUHOV</h2>
                        <h1 className="subtitle">ведущий на мероприятие <br/>без компромисса</h1>
                    </div>

                    <svg className="main__head-divider" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2 120" fill="none">
                        <path d="M1 0V120" stroke="#9F463F" strokeOpacity="0.3" strokeWidth="1" strokeDasharray="4 4"/>
                    </svg>

                    <div className="main__head-block right">
                        <h2>MERO</h2>
                        <h2 className="subtitle">лучшее решение <br/>для вашего счастья</h2>
                    </div>
                </div>
            </div>
        </div>
