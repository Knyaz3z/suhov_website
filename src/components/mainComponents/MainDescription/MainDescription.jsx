...
const STAGES = [
    ...
    {
        id: 4,
        desc: 'Контроль всех деталей мероприятия. \n От музыкального сопровождения до точного тайминга - всё под моим надзором.',
    },
    {
        id: 5,
            ...
            <div id='about' className="description__wrapper container">
                ...
                <div className="description__content">
                    ...
                    <div className="description__content-text">
                        <p>
                            Меня зовут Анатолий Сухов, я — профессиональный ведущий мероприятий с 10-летним сценическим опытом.
